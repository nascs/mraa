...
mraa_arm_platform()
{
    ...
    if (platform_type == MRAA_UNKNOWN_PLATFORM) {
        ...
        else if (mraa_file_contains("/proc/device-tree/model", PLATFORM_NAME_RADXA_NX5_IO))
            platform_type = MRAA_RADXA_NX5_IO;
    ...
    switch (platform_type) {
        ...
        case MRAA_RADXA_ROCK_5A:
            ...
            break;
        case MRAA_RADXA_NX5_IO:
            plat = mraa_radxa_nx5_io();
            break;
        case MRAA_ROCKPI4:
            plat = mraa_rockpi4();
            break;
