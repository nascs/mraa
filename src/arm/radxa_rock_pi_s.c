...
mraa_radxa_rock_pi_s()
{
    ...
    mraa_radxa_rock_pi_s_pininfo(b, 23, 1, 24, (mraa_pincapabilities_t){1,1,0,0,1,1,0,1}, "GPIO1_D0");
    mraa_radxa_rock_pi_s_pininfo(b, 24, 1, 25, (mraa_pincapabilities_t){1,1,0,0,0,0,0,0}, "GPIO1_D1");
